...
> **Status: work in progress.** The homepage is built. Menu, About and Visit pages are not.
...
| **Menu** | Photo band drifting right to left, continuously. Built from the 2025 menu photography |
...
```
site/
  index.html            ← the site. Edit this one.
  index.build.html      ← generated single-file copy. Do not edit.
  assets/
...
docs/
  ...
  02-menu.md            all 75 menu items transcribed with prices
...
5. **Confirm the 2025 menu prices** are still current.
